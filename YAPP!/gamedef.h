...
void tuto(Player *player, int *save, char (*map)[WIDTH], TRAP trap[],int * stage, MapBox (*mapbox)[WIDTH], Bullet *player_bullet, int *player_bullet_count, int *enemy_count);	//튜토리얼함수다
...
void clear(int a,int b, int c, int d, Player * player,int * stage, int stagename, Bullet *player_bullet, int *player_bullet_count, int *enemy_count);	//좌위우아래 순으로 초기화
